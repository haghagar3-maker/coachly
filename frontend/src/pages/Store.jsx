...
export default function Store() {
  ...
  const socials = [
    ...
    { key: 'tiktok', icon: 'TT', label: 'TikTok' },
    { key: 'youtube', icon: 'YT', label: 'YouTube' },
    { key: 'twitter', icon: 'X', label: 'Twitter' },
        ...
        <div>
          ...
          {activeTab === 'program' && (
            <div>
              ...
              {[
                { title: 'Custom workout program', desc: 'A 5-day/week program generated by AI using your coach\'s exact methodology. Updates every month based on your progress.' },
                { title: 'Daily meal plans', desc: 'Breakfast, lunch, snack and dinner planned every day. Tap any meal for the full recipe.' },
                { title: 'Food scan & tracking', desc: 'Take a photo of any meal to instantly get calories, protein, carbs and fat. Your coach sees your eating habits.' },
                { title: 'AI coach (24/7)', desc: 'A personalised AI trained on your coach\'s methods. Ask about workouts, nutrition, motivation — anytime.' },
                { title: 'Direct coach messaging', desc: 'Message your real human coach directly. They typically reply within 24–48h.' },
                { title: 'Weekly check-ins', desc: 'Log your weight, energy, sleep and motivation weekly. Your coach reviews and adjusts your plan.' },
                { title: 'Community access', desc: 'Join a community of clients on the same journey. Share wins, ask questions, stay motivated.' },
                { title: 'Content library', desc: 'Exclusive videos, guides and resources from your coach — unlocked week by week.' },
                              ].map((item, i) => (
